// Code generated by the Encore v1.46.21 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-xve4u.encr.app`
}
...
/**
 * Client is an API client for the xve4u Encore application.
 */
...
export namespace accounts {
    ...
    export class ServiceClient {
        ...
        public async Refresh(params: RefreshParams): Promise<RefreshResponse> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/refresh`, undefined, {headers})
        ...
        public async Validate(params: ValidateParams): Promise<ValidateResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/auth/validate`, JSON.stringify(params))
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if ( typeof globalThis === "object" && !("window" in globalThis) ) {
            this.headers["User-Agent"] = "xve4u-Generated-TS-Client (Encore/v1.46.21)";
        }
